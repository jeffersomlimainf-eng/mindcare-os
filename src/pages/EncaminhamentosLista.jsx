            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl overflow-hidden shadow-sm border border-slate-200 dark:border-slate-800">
                        ...
                        <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                            {filtrados.map((e, i) => (
                                <tr
                                    ...
                                    onDoubleClick={() => navigate(`/encaminhamentos/${e.id}`)}
                                >
                ...
                {filtrados.length === 0 && (
                    <div className="flex flex-col items-center justify-center py-12 text-center">
                        <span className="material-symbols-outlined text-4xl text-slate-200 mb-2">send</span>
                        <h3 className="text-sm font-bold text-slate-400">Nenhum encaminhamento encontrado</h3>
                    </div>
                )}
            </div>
