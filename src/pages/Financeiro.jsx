                                    ...
                                    <td className="px-4 md:px-6 py-3 md:py-4 text-right">
                                        <div className="flex gap-2 justify-end">
                                            ...
                                            {l.status === 'Pendente' && l.tipo?.toLowerCase() === 'receita' && (() => {
                                                ...
                                                const link = generateWhatsAppLink(p.phone, messages.billing(
                                                    p.nome, 
                                                ...
                                                return (
                                                    <a 
                                                        ...
                                                        className="size-8 flex items-center justify-center rounded-lg bg-[#25D366] text-white hover:scale-110 transition-all shadow-sm"
