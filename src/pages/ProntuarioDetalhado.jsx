        ...
        <div className="space-y-6">
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-start md:items-center">
                    ...
                    <div className="flex flex-wrap w-full md:w-auto mt-4 md:mt-0 gap-3">
                        ...
                        <div className="relative">
                            ...
                            >
                                <span className="material-symbols-outlined text-xl">{showOptions ? 'close' : 'add'}</span> Novo Registro
                            </button>
                                    ...
                                    <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-100 dark:border-slate-700 py-2 z-20 animate-in fade-in zoom-in duration-200">
                                        {[
                                            ...
                                            <button
                                                key={i}
                                                onClick={() => {
                                                    navigate(opt.path, { state: { pacienteObjeto: paciente } });
            ...
            <div className="min-h-[400px]">
                ...
                {abaAtiva === 'anamnese' && (
                    <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-8 shadow-sm">
                        <div className="flex justify-between items-center mb-8">
                            ...
                            <button 
                                onClick={() => navigate('/anamneses/novo', { state: { pacienteObjeto: paciente } })}
                ...
                {abaAtiva === 'portal-paciente' && (
                    <PortalPacienteTab paciente={paciente} user={user} />
                )}
