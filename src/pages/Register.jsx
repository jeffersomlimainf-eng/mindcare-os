                        ...
                        <>
                            ...
                            <form onSubmit={handleRegister} className="space-y-4">
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full mt-4 py-3.5 bg-gradient-to-r from-violet-400 to-purple-400 text-white font-bold rounded-xl shadow-lg shadow-violet-200/40 hover:shadow-violet-300/50 hover:from-violet-500 hover:to-purple-500 transition-all active:scale-[0.99] uppercase tracking-widest text-xs disabled:opacity-50"
                                >
